...
// module
exports.push([module.i, "#wizard-footer {\n  display: flex;\n  flex: 0 0 auto;\n  justify-content: center;\n  align-items: center;\n  background-color: white;\n  width: 100%;\n  height: 80px; }\n  #wizard-footer #bottom-indicators {\n    display: flex;\n    flex-direction: row;\n    height: calc(80px / 2);\n    justify-content: center; }\n  #wizard-footer > .column {\n    display: flex;\n    flex: 1 1 0%;\n    height: 100%; }\n    #wizard-footer > .column.center {\n      flex-direction: column;\n      justify-content: flex-end;\n      align-content: center;\n      max-width: 350px; }\n    #wizard-footer > .column.right {\n      align-items: flex-end; }\n      #wizard-footer > .column.right .save-success-container {\n        display: flex;\n        align-items: center;\n        margin-left: 1rem;\n        height: calc(80px / 2); }\n        #wizard-footer > .column.right .save-success-container svg.save-success-indicator {\n          width: 2rem;\n          height: 2rem;\n          margin-right: 0.5rem; }\n  #wizard-footer #bottom-buttons {\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    align-content: space-around;\n    height: calc(80px / 2);\n    flex-wrap: wrap;\n    align-self: center;\n    width: 100%; }\n    #wizard-footer #bottom-buttons > section {\n      display: flex;\n      flex: 2 1 0%; }\n      #wizard-footer #bottom-buttons > section:nth-of-type(1) {\n        justify-content: flex-start; }\n      #wizard-footer #bottom-buttons > section:nth-of-type(2) {\n        justify-content: center; }\n        #wizard-footer #bottom-buttons > section:nth-of-type(2) > button {\n          margin: 0 5px; }\n      #wizard-footer #bottom-buttons > section:nth-of-type(3) {\n        justify-content: flex-end; }\n    #wizard-footer #bottom-buttons button {\n      display: flex;\n      flex: 1 0 auto;\n      flex-grow: 0;\n      justify-content: center; }\n      #wizard-footer #bottom-buttons button svg {\n        width: 2rem;\n        height: 2rem; }\n      #wizard-footer #bottom-buttons button .oc-icon-indicator {\n        fill: white; }\n  #wizard-footer .tab-indicator {\n    width: 10px;\n    height: 10px;\n    background: gray;\n    border-radius: 5px;\n    margin: 5px; }\n  #wizard-footer .tab-highlight {\n    background: #EC6608; }\n", ""]);
...
var WizardFooter = (_temp2 = _class = function (_React$PureComponent) {
  ...
  steps: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    name: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.oneOfType([__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string, __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.element]).isRequired,
